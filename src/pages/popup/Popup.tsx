...
export const Popup: React.FC = () => {
  ...
  return (
    <div className="p-0 min-w-[360px] bg-slate-50 dark:bg-slate-950 shadow-2xl rounded-xl overflow-hidden border border-slate-200 dark:border-slate-800">
      {/* Branded Header */}
      ...
      <div className="p-6 space-y-5">
        <div className="space-y-3">
          ...
          <Select value={currency} onValueChange={handleCurrencyChange}>
            ...
            <SelectContent side="bottom" sideOffset={8} className="border-slate-200 dark:border-slate-800">
      ...
      <div className="px-6 py-4 bg-white/50 dark:bg-black/20 border-t border-slate-100 dark:border-slate-800 flex justify-between items-center">
