...
export const Popup: React.FC = () => {
  ...
  return (
    <div className="p-0 min-w-[380px] min-h-[450px] bg-[#f8fafc] shadow-2xl overflow-hidden border border-[#e2e8f0] flex flex-col">
      {/* Premium Header */}
      ...
      <div className="px-8 py-6 space-y-6 flex-grow overflow-y-auto">
        ...
        <div className={cn(
          ...
          <div className="space-y-2.5">
            <Label htmlFor="currency" className="text-[13px] font-semibold text-slate-500 ml-1">
              Целевая валюта
            </Label>
            <Select value={currency} onValueChange={handleCurrencyChange}>
              <SelectTrigger id="currency" className="w-full h-13 bg-white border-[#e2e8f0] hover:border-[#0064d2] focus:ring-4 focus:ring-[#0064d2]/5 transition-all rounded-2xl shadow-sm text-[15px] font-bold px-5">
          ...
          {myFinData && (
            <div className="space-y-2.5 animate-in fade-in slide-in-from-top-2 duration-500">
              <Label htmlFor="bank" className="text-[13px] font-semibold text-slate-500 ml-1 flex items-center gap-2">
                <Landmark className="h-3.5 w-3.5 opacity-60" />
                Источник курса
              </Label>
              <Select value={selectedBank} onValueChange={handleBankChange}>
                <SelectTrigger id="bank" className="w-full h-13 bg-white border-[#e2e8f0] hover:border-[#0064d2] focus:ring-4 focus:ring-[#0064d2]/5 transition-all rounded-2xl shadow-sm text-[15px] font-bold px-5">
                  <SelectValue placeholder="Выберите банк" />
                </SelectTrigger>
                <SelectContent position="popper" side="bottom" sideOffset={8} avoidCollisions={false} className="rounded-2xl border-[#e2e8f0] shadow-2xl max-h-[300px] w-[var(--radix-select-trigger-width)] p-1.5">
          ...
          <div className="space-y-2.5">
            ...
            <div className="group flex items-center justify-between bg-slate-100/50 p-5 rounded-2xl border border-transparent hover:border-[#e2e8f0] transition-all relative overflow-hidden">
